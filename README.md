...
will be used to actually train and run the perceptron classifier on csv data

### keras_classifier.py

can be run when you have generated a file of samples called samples-tictactoe.csv
